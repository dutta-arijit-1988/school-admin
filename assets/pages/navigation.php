  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
      <ul class="nav" id="side-menu">
        ...
        <li> <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Company Details<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a href="company.php">Add New</a> </li>
            <li> <a href="company_list.php">View</a> </li>
          </ul>
          <!-- /.nav-second-level -->
        </li>
        <li> <a href="#"><i class="fa fa-table fa-fw"></i> Billings<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a href="add_bill.php">Add Bill</a> </li>
            <li> <a href="view_bill.php">View Bill</a> </li>
            <li> <a href="search_bill.php">Search Bill</a> </li>
          </ul> 
          <!-- /.nav-second-level -->
        </li>
