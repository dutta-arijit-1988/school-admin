...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            $attributes = array("id"        => "addStudentForm",
                                "name"      => "addStudentForm",
                                "method"    => "post",
                                "role"      => "form",
            ...
            echo form_open("students/create_student", $attributes);
            ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="officialDetailsFormNumberDiv">
                                    ...
                                    <input type="text" name="form_number" id="form_number" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="officialDetailsJoiningDateDiv">
                                    ...
                                    <input type="text" name="joining_date" id="joining_date" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="officialDetailsRollNoDiv">
                                    <label class="control-label">Roll No.</label>
                                    <input type="text" name="roll_no" id="roll_no" class="form-control" placeholder="" value="" onkeypress="return validateFloatKeyPress(this,event);">
                                </div>
                            </div>
                        </div> 
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="personalDetailsDateOfBirthDiv">
                                    ...
                                    <input type="text" name="date_of_birth" id="date_of_birth" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="personalDetailsBirthPlaceDiv">
                                    ...
                                    <input type="text" name="birth_place" id="birth_place" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="personalDetailsNationalityDiv">
                                    <label class="control-label">Nationality</label>
                                    <input type="text" name="nationality" id="nationality" class="form-control" placeholder="" value="Indian" readonly="readonly">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="personalDetailsMotherTongueDiv">
                                    <label class="control-label">Mother Tongue</label>
                                    <input type="text" name="mother_tongue" id="mother_tongue" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="personalDetailsReligionDiv">
                                    ...
                                    <input type="text" name="religion" id="religion" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="personalDetailsAadharNumberDiv">
                                    <label class="control-label">Aadhar Number</label>
                                    <input type="text" name="aadhar_number" id="aadhar_number" class="form-control" placeholder="" value="" onkeypress="return validateFloatKeyPress(this,event);">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group" id="contactDetailsPermanentAddressDiv">
                                    ...
                                    <textarea class="form-control" rows="4" name="permanent_address" id="permanent_address" placeholder=""></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group" id="contactDetailsPresentAddressDiv">
                                    <label class="control-label">Present Address</label>
                                    <textarea class="form-control" rows="4" name="present_address" id="present_address" placeholder=""></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="contactDetailsPincodeDiv">
                                    ...
                                    <input type="text" name="pincode" id="pincode" class="form-control" placeholder="" value="" onkeypress="return validateFloatKeyPress(this,event);">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="contactDetailsMobileDiv">
                                    <label class="control-label">Mobile</label>
                                    <input type="text" name="mobile" id="mobile" class="form-control" placeholder="" value="" onkeypress="return validateFloatKeyPress(this,event);">
                                </div>
                            </div>
                        </div>
                        <div class="row">                            
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="fatherDetailsNameDiv">
                                    ...
                                    <input type="text" name="father_name" id="father_name" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="fatherDetailsMobileDiv">
                                    <label class="control-label">Mobile</label>
                                    <input type="text" name="father_mobile" id="father_mobile" class="form-control" placeholder="" value="" onkeypress="return validateFloatKeyPress(this,event);">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="fatherDetailsJobDiv">
                                    <label class="control-label">Job</label>
                                    <input type="text" name="father_job" id="father_job" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="fatherDetailsAadharNumberDiv">
                                    <label class="control-label">Aadhar Number</label>
                                    <input type="text" name="father_aadhar_number" id="father_aadhar_number" class="form-control" placeholder="" value="" onkeypress="return validateFloatKeyPress(this,event);">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="fatherDetailsQualificationDiv">
                                    <label class="control-label">Qualification</label>
                                    <input type="text" name="father_qualification" id="father_qualification" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="motherDetailsNameDiv">
                                    <label class="control-label">Name</label>
                                    <input type="text" name="mother_name" id="mother_name" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="motherDetailsMobileDiv">
                                    <label class="control-label">Mobile</label>
                                    <input type="text" name="mother_mobile" id="mother_mobile" class="form-control" placeholder="" value="" onkeypress="return validateFloatKeyPress(this,event);">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="motherDetailsJobDiv">
                                    <label class="control-label">Job</label>
                                    <input type="text" name="mother_job" id="mother_job" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="motherDetailsAadharNumberDiv">
                                    <label class="control-label">Aadhar Number</label>
                                    <input type="text" name="mother_aadhar_number" id="mother_aadhar_number" class="form-control" placeholder="" value="" onkeypress="return validateFloatKeyPress(this,event);">
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group" id="motherDetailsQualificationDiv">
                                    <label class="control-label">Qualification</label>
                                    <input type="text" name="mother_qualification" id="mother_qualification" class="form-control" placeholder="" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group" id="otherDetailsRemarksDiv">
                                    ...
                                    <textarea class="form-control" rows="4" name="remarks" id="remarks" placeholder=""></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group" id="otherDetailsTotalFeesDiv">
                                            ...
                                            <input type="text" name="total_fees" id="total_fees" class="form-control" placeholder="" value="" onkeypress="return validateFloatKeyPress(this,event);">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group" id="otherDetailsAdmissionByDiv">
                                            ...
                                            <input type="text" name="admission_by" id="admission_by" class="form-control" placeholder="" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
